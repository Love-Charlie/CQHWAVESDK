...
//        [wxBtn.imageView setContentMode:UIViewContentModeScaleToFill];
        ...
        [wxLabel setFont:[UIFont systemFontOfSize:12.0]];
        ...
        [appleLabel setFont:[UIFont systemFontOfSize:12.0]];
...
//        phontBtn.layer.masksToBounds = YES;
        ...
        [phoneLabel setFont:[UIFont systemFontOfSize:12.0]];
...
//        [kuaisuBtn setBackgroundColor:[UIColor colorWithRed:216/255.0 green:58/255.0 blue:41/255.0 alpha:1]];
        [kuaisuBtn setBackgroundImage:[CQHTools bundleForImage:@"快速注册登录按钮11" packageName:@""] forState:UIControlStateNormal];
