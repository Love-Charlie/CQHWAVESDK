...
//    NSLog(@"transactions.count = %ld",transactions1.count);
...
//    NSArray *transactions1 = [SKPaymentQueue defaultQueue].transactions;
//    NSLog(@"transactions.count = %ld",transactions1.count);
//    if (transactions1.count > 0) {
//                SKPaymentTransaction *transaction = [transactions1 firstObject];
...
//                }
//            }
//    for (SKPaymentTransaction *transaction in transactions1) {
//        [[SKPaymentQueue defaultQueue] finishTransaction:transaction];
//        return;
//    }
    // 处理结果
    for (SKPaymentTransaction *transaction in transactions) {
        ...
        if (SKPaymentTransactionStatePurchased == transaction.transactionState) {
            ...
            [self.delegate CQHToolBoughtProductSuccessedWithProductID:transaction andInfo:nil];
